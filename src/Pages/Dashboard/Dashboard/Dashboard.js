        ...
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-gray-800">
            ...
            <span className="text-primary">
              {user ? user.displayName : mongoUser.name}!
            </span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white shadow rounded-lg p-6">
            <div className="flex items-center">
              {mongoUser?.photoURL ? (
                <img
                  className="w-16 rounded-full -mt-9 p-[3px] border-2 border-white"
                  src={mongoUser?.photoURL}
                  alt="profile"
                />
              ) : (
                <FaUserCircle
                  className="rounded-full -mt-4 p-[1px] border-2 border-secondary text-primary"
                  size={50}
                />
              )}
              <div className="ml-4">
